...
function Calendar({
  ...
  if (view === "years") {
    ...
    return (
      <div className={cn("bg-background p-3", calendarSize, className)} data-slot="calendar">
  ...
  return (
    <div className={cn("bg-background p-3", calendarSize, className)} data-slot="calendar">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          type="button"
          className="h-8 px-2 font-medium capitalize flex items-center gap-1 hover:bg-accent hover:text-accent-foreground rounded-md transition-colors text-sm"
          onClick={() => {
