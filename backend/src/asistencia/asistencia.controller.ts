...
export class AsistenciaController {
  ...
  @ApiOperation({
    summary:
      'Obtener QRs disponibles para registro (activos, en horario y no registrados aún)',
  })
  ...
  @Delete('qr/:id')
  @Roles('admin')
  @ApiOperation({ summary: 'Eliminar QR de asistencia (solo admin)' })
  async deleteQR(@Param('id', ParseIntPipe) id: number) {
    return this.asistenciaService.deleteQR(id);
  }
  ...
  async confirmarAsistencia(
    ...
    return this.asistenciaService.confirmarAsistencia(
      id,
      dto,
      this.getUserId(req),
    );
  ...
  async confirmarMultiples(
    ...
    return this.asistenciaService.confirmarMultiples(
      body.ids,
      body.estado,
      this.getUserId(req),
    );
  ...
  @Delete(':id')
  @Roles('admin')
  @ApiOperation({ summary: 'Eliminar asistencia (solo admin)' })
  async deleteAsistencia(@Param('id', ParseIntPipe) id: number) {
